...
public class GdxSetup {
	...
	public void build (ProjectBuilder builder, String fromTemplate, String outputDir, String appName, String packageName, String mainClass,
		...
		project.files.add(new TemporaryProjectFile(template, builder.settingsFile, "settings.gradle", false));
		project.files.add(new TemporaryProjectFile(template, builder.buildFile, "build.gradle", true));
		...
		if(builder.modules.contains(ProjectType.IOSMOE)) {			
			project.files.add(new ProjectFile(template, "ios-moe/src/IOSMoeLauncher", "ios-moe/src/" + packageDir + "/IOSMoeLauncher.java", true));			
			project.files.add(new ProjectFile(template, "ios-moe/xcode/ios-moe/Default-1024w-1366h@2x~ipad.png", false));
			project.files.add(new ProjectFile(template, "ios-moe/xcode/ios-moe/Default-375w-667h@2x.png", false));
			project.files.add(new ProjectFile(template, "ios-moe/xcode/ios-moe/Default-414w-736h@3x.png", false));
			project.files.add(new ProjectFile(template, "ios-moe/xcode/ios-moe/Default-568h@2x.png", false));
			project.files.add(new ProjectFile(template, "ios-moe/xcode/ios-moe/Default.png", false));
			project.files.add(new ProjectFile(template, "ios-moe/xcode/ios-moe/Default@2x.png", false));
			project.files.add(new ProjectFile(template, "ios-moe/xcode/ios-moe/Default@2x~ipad.png", false));
			project.files.add(new ProjectFile(template, "ios-moe/xcode/ios-moe/Default~ipad.png", false));
			project.files.add(new ProjectFile(template, "ios-moe/xcode/ios-moe/Icon-72.png", false));
			project.files.add(new ProjectFile(template, "ios-moe/xcode/ios-moe/Icon-72@2x.png", false));
			project.files.add(new ProjectFile(template, "ios-moe/xcode/ios-moe/Icon.png", false));
			project.files.add(new ProjectFile(template, "ios-moe/xcode/ios-moe/Icon@2x.png", false));
			project.files.add(new ProjectFile(template, "ios-moe/xcode/ios-moe/Info.plist", true));
			project.files.add(new ProjectFile(template, "ios-moe/xcode/ios-moe/custom.xcconfig", false));
			project.files.add(new ProjectFile(template, "ios-moe/xcode/ios-moe/main.cpp", false));
			project.files.add(new ProjectFile(template, "ios-moe/xcode/ios-moe-Test/Info.plist", false));
			project.files.add(new ProjectFile(template, "ios-moe/xcode/ios-moe-Test/main.cpp", false));
			project.files.add(new ProjectFile(template, "ios-moe/xcode/ios-moe.xcodeproj/project.pbxproj", true));
			project.files.add(new ProjectFile(template, "ios-moe/build.gradle", true));
		}
	...
	public static void main (String[] args) throws IOException {
		...
		if (!params.containsKey("dir") ||
			...
			builder.build();
			new GdxSetup().build(builder, "default", params.get("dir"), params.get("name"), params.get("package"), params.get("mainClass"),
